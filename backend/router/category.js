...
const {cre_category, show_category, delete_category,update_category,permission_cat,all_category}=require('../controller/category')
...
router.route('/all_category').get(token_decode,check_user('admin'),all_category)
